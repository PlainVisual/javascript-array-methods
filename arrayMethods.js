...
const outcomeSortDate = inventors.filter((inventor) => {
...
const outcomeInventorBirthday = inventors.map((inventor) => {

  return inventor.year;

})

console.log(outcomeInventorBirthday);
...
const outcomeFullName = inventors.map((inventor) => {

  return `${inventor.first} ${inventor.last}`;

})

console.log(outcomeFullName);
...
const outcomeSortBirth = inventors.sort((a, b) => {
  
  return a.year - b.year;
  
})

console.log(outcomeSortBirth);
...
const outcomeSortPassed = inventors.sort((a, b) => {
...
console.table(outcomeSortPassed);
...
const outcomeInventor = inventors.find((inventor) => {
